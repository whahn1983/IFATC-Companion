...
Status at the time of writing: `:core` is **1020 tests / 85 classes / 0 failures**; `:app`
...
**Status: 73 of the 100 are closed and three are partly closed, and all 37 rated high are
done.** What remains is 11 medium and 13 low, listed with their evidence in
